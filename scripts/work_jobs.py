...
def get_handler(job_type: str) -> Callable[[Job, Engine, IBSessionPool], dict] | None:
    handlers: dict[str, Callable[[Job, Engine, IBSessionPool], dict]] = {
        JOB_TYPE_POSITIONS_SYNC_TWS: handle_positions_sync,
        ...
        JOB_TYPE_TRADES_SYNC_TWS: handle_trades_sync,
        JOB_TYPE_TRADES_SYNC_FLEXQUERY: handle_flex_trades_sync,
        JOB_TYPE_POSITIONS_SYNC_FLEXQUERY: handle_flex_positions_sync,
