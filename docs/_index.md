...
| [trades-and-executions-sync.md](trades-and-executions-sync.md)       | Trade/position ingestion via FlexQuery (TWS dormant), spread/combo detection, corrections, idempotency, `flex_sync_log`, job payload options and retry cadence |
