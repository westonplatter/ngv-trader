...
| [spec-activated-products-security-master.md](spec-activated-products-security-master.md)     | Implemented — activated-products table, IBKR exchange discovery, 12-month sync, UI listing |
